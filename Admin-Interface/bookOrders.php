...
<?php
	...
	$stmt= $db->query("select * from transcationbook ");
...
<?php
	...
	// where txnStatus='TXN_SUCCESS' AND OrderStatus='Order Cancelled'
	$stmt= $db->query("select * from transcationbook");
	while($row=$stmt->fetch()){	
?>
<tr> <td ><?php echo $row['Cid']." " ?></td> <td><?php echo $row['name']." " ?></td><td><?php echo $row['OrderID']." " ?></td>
...
<?php
	...
	// where txnStatus='TXN_SUCCESS' AND OrderStatus!='Order Cancelled' AND OrderStatus='Delivered'
	$stmt= $db->query("select * from transcationbook ");
	while($row=$stmt->fetch()){	
?>
<tr> <td ><?php echo $row['Cid']." " ?></td> <td><?php echo $row['name']." " ?></td><td><?php echo $row['OrderID']." " ?></td>
