...
<?php
	...
	product.author AS author,product.image AS image, product.price* orderlist.Quantity AS totalAmount,
...
echo "Order Is cancelled on :<br>" .$Ddate;
  ...
  <form method="post" id="myform" action="cancelOrder.php">
	<input type="hidden" name="cancel_id" id="cancelID" value="<?php echo $OrderId; ?>" style="color:black"/>
	<button type="submit" value="submit" id="cancel" class="btn btn-outline-warning" name="cancel_btn">Cancel Order</button>
</form>
<?php } ?>
</h5>
</div>
