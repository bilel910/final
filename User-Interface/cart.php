...
<?php
  ...
  product.author AS author,product.image AS image, product.price*cart.Quantity AS totalAmount,
...
<td><P><?php echo $row['Quantity']?>Pies</p></td>
	...
	<button type="submit" value="submit" class="btn btn-danger" name="remove_btn">Remove</button>	</form></td>
		...
		<?php } ?>
<tr style="text-align:right;"><td colspan="6"><h5 style="color:red;padding-top:5px;">SUBTOTAL :&nbsp;TND<B><?php echo number_format( $subTotal, 2 ); ?></B></h5>
</td></tr>
<tr style="text-align:right;"><td colspan="6"><h5 style="color:red;padding-top:5px;">TAXES :&nbsp;TND<B><?php echo number_format( $tax * $quan, 2 ); ?></B></h5>
</td></tr>
<tr style="text-align:right;"><td colspan="6"><h5 style="color:red;padding-top:5px;">TOTAL :&nbsp;TND<B><?php echo number_format( $subTotal+($tax * $quan), 2 ); ?></B></h5>
</td></tr>              
 ...
 <h4 style="text-align:left;">Name:</h4>
  <div class="form-row" >
    ...
    <div class="form-group col-md-6">
      <input type="text" class="form-control" name="fname" pattern="[A-Z]{0,15}[a-z]{0,15}"  placeholder="First Name"/>
    </div>
    <div class="form-group col-md-6">
      <input type="Text" class="form-control" name="lname" pattern="[A-Z]{0,15}[a-z]{0,15}" placeholder="Last Name"/>
    </div>
...
<h4 style="text-align:left;color:red;padding-top:5px;">TOTAL:&nbsp;TND<B><?php echo number_format( $subTotal+($tax * $quan), 2 ); ?></B></h4>
...
Mobile: +21652005403<br>
Email:Inspirebook@gmail.com<br>
<b>FOR ANY ASSISTANCE</b><br><i class="fa fa-phone"></i>&nbsp;25469781
<br><br>
</div>
