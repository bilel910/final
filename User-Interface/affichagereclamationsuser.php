...
<body>
    <nav class="navbar navbar-expand-lg navbar-dark bg-primary">
        <div class="container-fluid">
          <a class="navbar-brand" href="#">Inspirebook</a>
   ...
   <?php
        ...
        // where emailuser ='inspirebook@gmail.co'
        $sql =  "SELECT * FROM reclamations ";
        print "<form action ='supprimer.php' >";
            print "<table class=table border=2, width=800>";
            print "<th class=col> email </th>";
            print "<th class=col> description </th>";
        ...
        foreach  ($conn->query($sql) as $row) {
            ...
            print "<td>". $row['reclamation'] . "</td>";



            print "<td><a href=supprimer.php?id={$row['id']};>Delete</a></td>";
